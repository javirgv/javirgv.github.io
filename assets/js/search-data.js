...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "projects",
          description: "Selected research, machine-learning, astronomy, and scientific computing projects.",
          section: "Navigation",
          handler: () => {
          ...
          title: "CV",
          description: "A summary of my education, research experience, technical skills, projects, teaching, leadership, awards, and selected activities.",
          section: "Navigation",
          handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/Javier_Roca_CV.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6A%61%76%69%35%72%67%76@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/javirgv", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/javierrocagarcia-valino", "_blank");
        },
      },{
      id: 'light-theme',
